...
* Support Python 3.15.
  ...
  `PR #181 <https://github.com/adamchainz/unittest-parametrize/pull/181>`__.
...
* Detect duplicate parameter IDs for tuples and single values, not only ``param`` instances.
  ...
  `PR #184 <https://github.com/adamchainz/unittest-parametrize/pull/184>`__.
...
* Switch package build backend from setuptools to `uv_build <https://docs.astral.sh/uv/concepts/build-backend/>`__.
  ...
  `PR #180 <https://github.com/adamchainz/unittest-parametrize/pull/180>`__.
